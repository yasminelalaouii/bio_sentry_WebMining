...
DATA_DIR  = os.path.join(ROOT, "data")   # toutes les données dans data/
ALERT_DIR = DATA_DIR                     # JSON + PNG axe 4
AXE3_JSON = os.path.join(DATA_DIR, "axe3_hits_results.json")
...
# ════════════════════════════════════════════════════════════════════════════
    ...
    st.markdown('<div class="section-header">Graphe de co-mentions (top 120 noeuds)</div>',
                unsafe_allow_html=True)
    axe3_graph_path = os.path.join(DATA_DIR, "axe3_G7_graph.png")
